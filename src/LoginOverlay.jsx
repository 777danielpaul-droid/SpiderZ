...
/* ============================================================
   LoginOverlay — Holo-Glass Modal für Google-OAuth.
...
export default function LoginOverlay({ onClose }) {
  const { signInWithGoogle, isSupabaseReady } = useAuth();
  ...
  const handleGoogle = async () => {
    ...
    // Bei OAuth wird die Seite weitergeleitet; nur bei Fehler bleiben wir hier.
    if (error) {
      setBusy(false);
